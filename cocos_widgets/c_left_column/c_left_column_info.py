...
from .c_icon import CIcon
from .c_left_button import CLeftButton
# IMPORT QT CORE
# ///////////////////////////////////////////////////////////////
...
class CLeftColumnInfo(QWidget):
    ...
    def setup_ui(self):
        ...
        self.icon = CIcon(self._icon_path, self._icon_color)
        ...
        self.btn_close.setObjectName("btn_close_left_column_info")
