...
from cocos_widgets.c_credits import CCredits
from cocos_widgets.c_left_column.c_left_column import CLeftColumn
from cocos_widgets.c_left_column.c_left_column_info import CLeftColumnInfo
