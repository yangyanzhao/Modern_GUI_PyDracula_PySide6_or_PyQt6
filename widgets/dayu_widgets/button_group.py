...
from widgets.dayu_widgets.menu import MMenu
from widgets.dayu_widgets.push_button import MPushButton
from widgets.dayu_widgets.qt import get_scale_factor
from widgets.dayu_widgets.radio_button import MRadioButton
from widgets.dayu_widgets.tool_button import MToolButton
...
class MCheckBoxGroup(MButtonGroupBase):
    ...
    def __init__(self, orientation=QtCore.Qt.Horizontal, parent=None):
        ...
        self._button_group.buttonClicked.connect(self.on_button_clicked)
        self._dayu_checked = []

    def on_button_clicked(self, button):
        """Handle button click event"""
        button_id = self._button_group.id(button)
        self._slot_map_signal.emit(button_id)
    def create_button(self, data_dict):
        return MCheckBox()
