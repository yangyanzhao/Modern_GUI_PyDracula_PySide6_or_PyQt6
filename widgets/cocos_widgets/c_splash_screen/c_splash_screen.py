...
from widgets.cocos_widgets.c_splash_screen.ui_main import Ui_MainWindow
from widgets.cocos_widgets.c_splash_screen.ui_splash_screen import Ui_SplashScreen
