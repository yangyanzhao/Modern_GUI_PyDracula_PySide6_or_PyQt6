...
from widgets.cocos_widgets.c_left_menu.c_div import CDiv
from widgets.cocos_widgets.c_left_menu.c_left_menu_button import CLeftMenuButton
...
class CLeftMenu(QWidget):
    ...
    def __init__(
        ...
        # ///////////////////////////////////////////////////////////////
        self.div_bottom = CDiv(dark_four)
