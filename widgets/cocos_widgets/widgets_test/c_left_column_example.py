...
from widgets.cocos_widgets.c_left_column.c_left_column import CLeftColumn
from widgets.cocos_widgets.c_left_column.c_left_column_info import CLeftColumnInfo
