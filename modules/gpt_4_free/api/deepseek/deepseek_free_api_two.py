...
token = "c9c763b94d4548418a93f574357c4aae"
...
class DeepseekAPITwo:
    ...
    async def main_chat(question, prompt="", timeout=60):
        ...
        try:
            result = await DeepseekAPITwo.chat(pool=pool, prompt=prompt,
...
if __name__ == '__main__':
    asyncio.run(DeepseekAPITwo.main_chat("什么是布里夫法则?"))
