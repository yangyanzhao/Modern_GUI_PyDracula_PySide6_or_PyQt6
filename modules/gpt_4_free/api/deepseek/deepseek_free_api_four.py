...
token = "e2e04a6bb12d42f1b55f53a3a06491ed"
...
class DeepseekAPIFour:
    ...
    async def main_chat(question, prompt="", timeout=60):
        ...
        try:
            result = await DeepseekAPIFour.chat(pool=pool, prompt=prompt,
...
if __name__ == '__main__':
    asyncio.run(DeepseekAPIFour.main_chat("那隽与李晓月为什么走不到最后,李晓月35以后会不会很惨"))
