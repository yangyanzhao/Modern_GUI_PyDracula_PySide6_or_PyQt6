...
token = "Bearer 3083fe042cc74cfcad815cf1eca9b030"
...
class DeepseekAPIOne:
    ...
    async def main_chat(question, prompt="", timeout=60):
        ...
        try:
            result = await DeepseekAPIOne.chat(pool=pool, prompt=prompt,
...
if __name__ == '__main__':
    result = asyncio.run(DeepseekAPIOne.main_chat("什么是布里夫法则"))
