...
token = "23f03f5bd92f3be40e9ed27059cb8a06"
...
class DouBaoAPIOne:
    ...
    async def main_chat(question, prompt="", timeout=60):
        ...
        try:
            result = await DouBaoAPIOne.chat(pool=pool, question=question, prompt=prompt, timeout=timeout)
            return result
        finally:
...
if __name__ == '__main__':
    asyncio.run(DouBaoAPIOne.main_chat("小樱是谁"))
