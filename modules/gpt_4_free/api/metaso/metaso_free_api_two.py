...
UID = "668f7b62108674c4dcd5b32a"
SID = "291b5cf3234646ce9b027542ab654b20"
token = f"{UID}-{SID}"
...
class MetasoAPITwo:
    ...
    async def main_chat(question, prompt="", timeout=60):
        ...
        try:
            result = await MetasoAPITwo.chat(pool=pool, question=question, prompt=prompt, timeout=timeout)
            return result
        finally:
