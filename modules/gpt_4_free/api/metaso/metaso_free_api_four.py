...
UID = "66407ecbba1757740e00da2d"
SID = "31e59b5594d545a081a7131f9b600290"
token = f"{UID}-{SID}"
...
class MetasoAPIFour:
    ...
    async def main_chat(question, prompt="", timeout=60):
        ...
        try:
            result = await MetasoAPIFour.chat(pool=pool, question=question, prompt=prompt, timeout=timeout)
            return result
        finally:
