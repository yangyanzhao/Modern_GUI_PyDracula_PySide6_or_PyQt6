...
UID = "666959dc00ddf38837a2621f"
SID = "ca50eea5b7a24019bd8316b2d499bb91"
token = f"{UID}-{SID}"
...
class MetasoAPIOne:
    ...
    async def main_chat(question, prompt="", timeout=60):
        ...
        try:
            result = await MetasoAPIOne.chat(pool=pool, question=question, prompt=prompt, timeout=timeout)
            return result
        finally:
