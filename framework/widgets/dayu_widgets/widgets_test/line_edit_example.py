...
from framework.widgets.dayu_widgets.qt import MIcon, MIconWidget

from framework.widgets.dayu_widgets import MTheme, MPushButton, MLineEdit
...
class DemoWidget(QWidget):
    def __init__(self, parent=None):
        ...
        m_line_edit.set_prefix_widget(MIconWidget(icon="folder_line.svg", color="#ddd"))
