...
from framework.widgets.dayu_widgets.utils import apply_formatter
from framework.widgets.dayu_widgets.utils import display_formatter
from framework.widgets.dayu_widgets.utils import font_formatter
from framework.widgets.dayu_widgets.utils import get_obj_value
from framework.widgets.dayu_widgets.utils import icon_formatter
from framework.widgets.dayu_widgets.utils import set_obj_value
...
class MSortFilterModel(QtCore.QSortFilterProxyModel):
    def __init__(self, parent=None):
        ...
        self.search_reg.setPatternOptions(QRegularExpression.CaseInsensitiveOption)
        ...
        if self.search_reg.pattern():
            for index, data_dict in enumerate(self.header_list):
                if data_dict.get("searchable", False):
                    ...
                    match = self.search_reg.match(six.text_type(value))
